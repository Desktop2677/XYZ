...
--local themes = {}
local theme = {
    accent = Color3.fromRGB(180, 91, 67),
    lightcontrast = Color3.fromRGB(41, 31, 56   ),
    darkcontrast = Color3.fromRGB(31, 22, 43),
    outline = Color3.fromRGB(26, 26, 26),
    inline = Color3.fromRGB(64, 54, 79),
...
do
    ...
    function pages:PlayerList(info)
        ...
        for Index = 1, 1 do
            ...
            --
            utility:LoadImage(button_gradient, "gradient", "https://img.freepik.com/premium-photo/blurry-abstract-background-black-white-gradient-apps-web-design-web-pages-banners-illustration-designxa_97567-2129.jpg")
            --
            library.began[#library.began + 1] = function(Input)
        ...
        --
        utility:LoadImage(list_gradient, "gradient", "https://img.freepik.com/premium-photo/blurry-abstract-background-black-white-gradient-apps-web-design-web-pages-banners-illustration-designxa_97567-2129.jpg")
        --
    ...
    function sections:Toggle(info)
        ...
        --
        utility:LoadImage(toggle__gradient, "gradient", "https://img.freepik.com/premium-photo/blurry-abstract-background-black-white-gradient-apps-web-design-web-pages-banners-illustration-designxa_97567-2129.jpg")
        --
        function toggle:Get()
        ...
        function toggle:Colorpicker(info)
            ...
            utility:LoadImage(colorpicker__gradient, "gradient", "https://img.freepik.com/premium-photo/blurry-abstract-background-black-white-gradient-apps-web-design-web-pages-banners-illustration-designxa_97567-2129.jpg")
            --
        ...
        function toggle:Keybind(info)
            ...
            --
            utility:LoadImage(keybind__gradient, "gradient", "https://img.freepik.com/premium-photo/blurry-abstract-background-black-white-gradient-apps-web-design-web-pages-banners-illustration-designxa_97567-2129.jpg")
            --
    ...
    function sections:Slider(info)
        ...
        --
        utility:LoadImage(slider__gradient, "gradient", "https://img.freepik.com/premium-photo/blurry-abstract-background-black-white-gradient-apps-web-design-web-pages-banners-illustration-designxa_97567-2129.jpg")
        --
    ...
    function sections:TextBox(info)
        ...
        --
        utility:LoadImage(textbox_gradient, "gradient", "https://img.freepik.com/premium-photo/blurry-abstract-background-black-white-gradient-apps-web-design-web-pages-banners-illustration-designxa_97567-2129.jpg")
        --
    ...
    function sections:Dropdown(info)
        ...
        utility:LoadImage(dropdown__gradient, "gradient", "https://img.freepik.com/premium-photo/blurry-abstract-background-black-white-gradient-apps-web-design-web-pages-banners-illustration-designxa_97567-2129.jpg")
        --
        if max then
    ...
    function sections:Multibox(info)
        ...
        utility:LoadImage(multibox__gradient, "gradient", "https://img.freepik.com/premium-photo/blurry-abstract-background-black-white-gradient-apps-web-design-web-pages-banners-illustration-designxa_97567-2129.jpg")
        --
                ...
                elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + multibox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + multibox.axis + (name and 15 or 0) + 20}) and not window:IsOverContent() then
                    ...
                    if not multibox.open then
                        ...
                        for i,v in pairs(multibox.options) do
                            ...
                            --
                            utility:LoadImage(multibox_value_gradient, "gradient", "https://img.freepik.com/premium-photo/blurry-abstract-background-black-white-gradient-apps-web-design-web-pages-banners-illustration-designxa_97567-2129.jpg")]]
                            --
